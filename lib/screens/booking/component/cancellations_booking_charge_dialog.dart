...
import 'package:fiksOpp/screens/booking/component/booking_cancelled_dialog.dart';
...
class CancellationsBookingChargeDialog extends StatefulWidget {
  ...
  CancellationsBookingChargeDialog(
      {required this.status, required this.isDurationMode});

  @override
  State<CancellationsBookingChargeDialog> createState() =>
      _CancellationsBookingChargeDialogState();
}

class _CancellationsBookingChargeDialogState
    extends State<CancellationsBookingChargeDialog> {
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            10.width,
                            PriceWidget(
                                price: widget.status.bookingDetail!
  ...
  void saveCancelClick() async {
    Map request = {
      ...
      CommonKeys.cancellationCharge:
          widget.status.bookingDetail!.cancellationCharges,
      CommonKeys.cancellationChargeAmount:
          widget.status.bookingDetail!.cancellationChargeAmount,
