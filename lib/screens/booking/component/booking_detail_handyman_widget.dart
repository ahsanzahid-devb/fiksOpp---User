              ...
              AppButton(
                ...
                onTap: () async {
                  ...
                  if (user != null) {
                    ...
                    isChattingAllow = widget.bookingDetail.canCustomerContact;
                    log(
                      "🔵 [CHAT-DEBUG] Handyman chat launch | status=${widget.bookingDetail.status} paymentStatus=${widget.bookingDetail.paymentStatus} canCustomerContact=$isChattingAllow",
                    );
                    UserChatScreen(
                            receiverUser: user,
