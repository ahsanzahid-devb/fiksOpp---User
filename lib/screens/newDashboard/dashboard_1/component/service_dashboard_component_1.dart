...
class ServiceDashboardComponent1 extends StatefulWidget {
  ...
  ServiceDashboardComponent1({
    ...
    // Defaults: show category label and enable navigation. For the user dashboard
    // we will explicitly pass flags to hide/disable where needed.
                      ...
                      child: Container(
                        ...
                        child: Marquee(
                          ...
                          child: Text(
                            ...
                            style: boldTextStyle(
                                color:
                                    appStore.isDarkMode ? white : Colors.black,
                                size: 10),
